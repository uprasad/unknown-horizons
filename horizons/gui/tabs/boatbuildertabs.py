...
class BoatbuilderFisherTab(BoatbuilderSelectTab):
	icon_path = 'content/gui/icons/tabwidget/boatbuilder/fisher_%s.png'
...
class BoatbuilderTradeTab(BoatbuilderSelectTab):
	icon_path = 'content/gui/icons/tabwidget/boatbuilder/trade_%s.png'
...
class BoatbuilderWar1Tab(BoatbuilderSelectTab):
	icon_path = 'content/gui/icons/tabwidget/boatbuilder/war1_%s.png'
...
class BoatbuilderWar2Tab(BoatbuilderSelectTab):
	icon_path = 'content/gui/icons/tabwidget/boatbuilder/war2_%s.png'
